...
collection = client.get_or_create_collection("Labour_Standards_IPGs", embedding_function=sentence_transformer_ef)
...
print("\nPassage embeddings shape", passage_embeddings.shape)
